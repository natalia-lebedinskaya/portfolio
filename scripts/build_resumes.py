...
EN = {
    ...
    "fit": ["<b>Target:</b> Middle Manual QA / API QA", "<b>Level:</b> Middle QA Engineer", "<b>Salary target:</b> from $1100/month", "<b>Availability:</b> remote start; Serbia-focused", "<b>Work format:</b> Belgrade office/hybrid first", "<b>Communication:</b> RU/UA native; English A2; Serbian A2"],
    ...
    "languages": ["Russian - native", "Ukrainian - native", "English - A2", "Serbian - A2"],
    ...
    "target": "Belgrade, Serbia is the first priority. Open to office/hybrid in Serbia and remote international work from Serbia. Russian-speaking teams or English/Serbian A2 communication are preferred.",
...
RU = {
    ...
    "fit": ["<b>Цель:</b> Middle Manual QA / API QA", "<b>Уровень:</b> Middle QA Engineer", "<b>Зарплата:</b> от $1100/мес", "<b>Старт:</b> remote start; фокус Сербия", "<b>Формат:</b> Белград office/hybrid в приоритете", "<b>Коммуникация:</b> RU/UA native; English A2; Serbian A2"],
    ...
    "languages": ["Русский - родной", "Украинский - родной", "Английский - A2", "Сербский - A2"],
    ...
    "target": "Первый приоритет - Белград, Сербия. Рассматриваю office/hybrid в Сербии и международную удаленную работу из Сербии. Предпочтительны русскоязычные команды или коммуникация на английском/сербском A2.",
